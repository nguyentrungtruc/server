...
export default {
	...
	methods: {
		...
		close: async function() {
			...
			this.$store.commit('CLOSE_COUPON_STATUS_DIALOG')
		},
		//Accept Update
	...
	computed: {
		...mapState({
			dialog     : state => state.couponStatus.dialog,
			editedIndex: state => state.couponStatus.editedIndex,
			item       : state => state.couponStatus.editedItem,
